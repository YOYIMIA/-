...
#include <mmsystem.h> // 用于MCI播放音频


// 定义是否自动启动收银台系统（可以通过预处理器定义控制）
#define AUTO_LAUNCH_CASHIER 1
...
BOOL CMFCApplication1App::InitInstance()
{
	...
	// 自动启动收银台系统（调试时使用）
#if defined(_DEBUG) && defined(AUTO_LAUNCH_CASHIER) && AUTO_LAUNCH_CASHIER
	// 延迟一点时间确保主窗口完全加载
	Sleep(100);
	...
	// 显示主对话框
	CCashierDialog cashierDlg;
	INT_PTR nResponse = cashierDlg.DoModal();
